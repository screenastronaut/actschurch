...
class Mega_Menu_Replacements {
	...
	public function woocommerce_header_add_to_cart_fragment( $fragments ) {
		...
		$fragments['span.mega-menu-woo-cart-total'] = "<span class='mega-menu-woo-cart-total amount'>" . wp_kses_data( WC()->cart->get_cart_subtotal() ) . "</span>";
	...
	public function shortcode_woo_cart_total() {
		...
		if ( function_exists('WC') ) {
			return "<span class='mega-menu-woo-cart-total amount'>" . wp_kses_data( WC()->cart->get_cart_subtotal() ) . "</span>";
		}
