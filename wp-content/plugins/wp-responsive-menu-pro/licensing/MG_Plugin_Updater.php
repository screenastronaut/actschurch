...
class MG_Plugin_Updater {
	...
	public function show_update_notification( $file, $plugin ) {
		...
		if ( ! empty( $update_cache->response[ $this->name ] ) && version_compare( $this->version, $version_info->new_version, '<' ) ) {
			...
			$changelog_link = self_admin_url( 'index.php?MG_action=view_plugin_changelog&plugin=' . $this->name . '&slug=' . $this->slug . '&TB_iframe=true&width=772&height=911' );
	...
	public function show_changelog() {
		...
		if( empty( $_REQUEST['MG_action'] ) || 'view_plugin_changelog' != $_REQUEST['MG_action'] ) {
			return;
		}
