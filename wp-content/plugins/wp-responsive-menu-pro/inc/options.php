...
function wpr_support_link() { 
	...
	<div class="queries-holder live-preview">	
		<div class="wpr-mobile-view">
			<iframe scrolling="yes" src="<?php echo get_site_url(); ?>"></iframe>
		</div>
	</div>
	<?php endif; ?>	
...
function wpr_add_responsive_menu( $menu ) {
	$menu['page_title']  = 'WP Responsive Menu Pro';
	$menu['menu_title']  = 'WPR Menu Pro';
	$menu['mode']		 = 'menu';
	$menu['menu_slug']   = 'wp-responsive-menu-pro';
	$menu['position']    = '200';
	return $menu;
}
