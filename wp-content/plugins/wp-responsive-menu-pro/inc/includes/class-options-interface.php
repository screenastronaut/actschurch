			...
			case "social" :
				...
				if( is_array ( $socials ) && count( $socials ) > 0 ) {
					foreach( $socials as $social ) {
						...
						$output .= '<input type="text" name="' . esc_attr( $option_name . '[' . $value['id'] . '][link][]' ) . '" class="social_link form-control" value="'.$social->link.'"><input type="button" class="btn btn-danger" value="Remove" /></div>';
					}
				}
				else {
