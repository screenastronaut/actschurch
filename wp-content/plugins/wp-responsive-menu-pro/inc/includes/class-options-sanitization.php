...
add_filter( 'wpr_of_sanitize_number', 'sanitize_text_field' );

/* Icon Field */

add_filter( 'wpr_of_sanitize_icon', 'sanitize_text_field' );
...
function wpr_of_sanitize_social( $input, $option ) {
	$output = '';
	$out = array();
	if ( is_array( $input ) ) {
...
add_filter( 'wpr_of_sanitize_social', 'wpr_of_sanitize_social', 10, 2 );
