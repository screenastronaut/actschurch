...
class Wpr_Options_Framework_Admin {
	...
	function enqueue_admin_styles( $hook ) {
		...
		wp_enqueue_style( 'wpr_optionsframework', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'css/wpr_optionsframework.css', array(),  Wpr_Options_Framework::VERSION );
		wp_enqueue_style( 'wpr_icons', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'icons/style.css', array(),  Wpr_Options_Framework::VERSION );

		wp_enqueue_style( 'wpr_iconpicker', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'css/jquery.fonticonpicker.min.css', array(),  Wpr_Options_Framework::VERSION );
		wp_enqueue_style( 'wpr_bootflat', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'css/site.min.css', array(),  Wpr_Options_Framework::VERSION );
	...
	function enqueue_admin_scripts( $hook ) {
		...
		wp_enqueue_script( 'icon-picker', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'js/jquery.fonticonpicker.min.js', array( 'jquery' ), Wpr_Options_Framework::VERSION );

		wp_enqueue_style( 'select2-style', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'css/select2.min.css', Wpr_Options_Framework::VERSION );

		// Enqueue custom option panel JS
		wp_enqueue_script( 'Select2-js', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'js/select2.full.js', array( 'jquery'), Wpr_Options_Framework::VERSION );

		wp_enqueue_script( 'options-custom', WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY . 'js/options-custom.js', array( 'jquery','wp-color-picker', 'icon-picker', 'Select2-js' ), Wpr_Options_Framework::VERSION );

		$option_var = array( 'font_type' => !empty($options['google_font_type']) ? $options['google_font_type'] : '',
										'options_path' => WPR_PRO_OPTIONS_FRAMEWORK_DIRECTORY,
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Responsive Menu Pro Options saved.', 'textdomain' ), 'updated fade in' );
	}
