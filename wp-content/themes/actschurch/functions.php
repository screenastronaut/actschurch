...
function ace_cpt() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'ACE Classes', 'text_domain' ),
		'name_admin_bar'        => __( 'ACE Class', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		...
		'view_items'            => __( 'View classes', 'text_domain' ),
		...
		'remove_featured_image' => __( 'Remove featured image', 'text_domain' ),
		'use_featured_image'    => __( 'Use as featured image', 'text_domain' ),
		'insert_into_item'      => __( 'Insert into Class', 'text_domain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this Class', 'text_domain' ),
		'items_list'            => __( 'Classes list', 'text_domain' ),
		'items_list_navigation' => __( 'Classes list navigation', 'text_domain' ),
		'filter_items_list'     => __( 'Filter Classes list', 'text_domain' ),
	);
	$args = array(
		'label'                 => __( 'Class', 'text_domain' ),
		'description'           => __( 'Custom Post Type for Classes', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array('title'),
		'hierarchical'          => false,
		'public'                => true,
	...
	register_post_type( 'ace', $args );

}
add_action( 'init', 'ace_cpt', 0 );
